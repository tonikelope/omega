...
FILES = ['channels/omega.py', 'channels/omega.json', 'servers/nei.py', 'servers/nei.json', 'resources/media/channels/banner/omega.gif', 'resources/media/channels/thumb/omega.gif', 'resources/media/channels/fanart/omega.gif']
